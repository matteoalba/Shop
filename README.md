...
- **Kafka UI**: [http://localhost:8081](http://localhost:8081) - Monitoring Kafka topics e messaggi
- **Adminer**: [http://localhost:8082](http://localhost:8082) - Interfaccia web database
